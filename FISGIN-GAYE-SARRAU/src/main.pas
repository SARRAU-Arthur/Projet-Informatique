...
uses Crt, unitunites, unitcalculsimple, unitequation, unitstatistiques, unithistorique;
...
repeat
  ...
  write('Menu: ');
  readln(menu);
  if (menu<>'C') and (menu<>'E') and (menu<>'S') and (menu<>'U') and (menu<>'Q') and (menu<>'H') then
    begin
    ClrScr();
